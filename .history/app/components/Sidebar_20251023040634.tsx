...
export default function Sidebar({
  ...
  return (
    <>
      ...
      <div className="lg:hidden fixed left-4 z-50" style={{ top: '50%', transform: 'translateY(-50%)' }}>
        <Button
          variant="outline"
          size="icon"
      ...
      <div className="hidden lg:block fixed left-4 z-[60]" style={{ top: '50%', transform: 'translateY(-50%)' }}>
        <Button
          variant="outline"
          size="icon"
          onClick={onToggle}
