  ...
  const accountData = useMemo(() => {
    ...
    if (showForecast) {
      ...
      forecastData = {
        monthlyEstimate,
        status,
        progress: monthlyEstimate > 0 ? (currentMonthExpense / monthlyEstimate) * 100 : 0,
        daysRemaining,
      };
    }
      ...
      <CardContent className="space-y-4">
        ...
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          <div className="flex items-center justify-center gap-1 mb-1">
            ...
            <span className="text-sm font-medium text-gray-700">Balanço do Mês</span>
          </div>
          <p className={`text-xl font-bold ${
            accountData.currentMonthBalance >= 0 ? 'text-green-600' : 'text-red-600'
          }`}>
        ...
        {accountData.forecastData && (
          <div className="border-t pt-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className={`text-xs ${getStatusColor(accountData.forecastData.status)}`}>
              ...
              <div className="space-y-1">
                ...
                <div className="w-full bg-gray-200 rounded-full h-2">
                  <div 
                    ...
                    style={{ 
                      width: `${Math.min(100, accountData.forecastData.progress)}%` 
                    }}
                  />
                </div>
                <div className="flex justify-between text-xs text-gray-500">
                  <span>{accountData.forecastData.daysRemaining} dias restantes</span>
