...
export default function RecoverAccountDialog({ children }: RecoverAccountDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Você pode recuperar contas excluídas nos últimos 30 dias. 
            Após esse período, as contas serão permanentemente removidas.
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4">
          {isLoading ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600">Nenhuma conta excluída encontrada.</p>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-600 capitalize">
                            {account.type === "personal" ? "Pessoal" : 
                             account.type === "shared" ? "Compartilhada" : 
                             account.type === "business" ? "Empresa" : 
                             account.type === "vehicle" ? "Veículo" : account.type}
                          </p>
                        </div>
                      </div>
                  ...
                  <CardContent className="pt-0">
                    <div className="flex items-center justify-between">
                      <div className="text-sm text-gray-600">
                        ...
                        {account.description && (
                          <p className="mt-1">Descrição: {account.description}</p>
                        )}
                      </div>
                      <Button
