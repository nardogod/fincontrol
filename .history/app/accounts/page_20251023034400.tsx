...
export default async function AccountsPage() {
  ...
  console.log("- Contas compartilhadas encontradas:", sharedAccounts?.length || 0);
  console.log("- Contas compartilhadas únicas:", uniqueSharedAccounts.length);
  console.log("- Total de contas:", accounts.length);
  console.log("- IDs das contas:", accounts.map(acc => ({ id: acc.id, name: acc.name, is_shared: acc.is_shared })));
