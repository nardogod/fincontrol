...
export default function AccountSettingsPage() {
  ...
  const loadAccountData = async () => {
    try {
      ...
      setAccount(typedAccountData as TAccount);
      setFormData({
        name: typedAccountData.name,
        type: typedAccountData.type,
  ...
  const handleDelete = async () => {
    try {
      ...
      if (account?.type === "principal") {
        throw new Error(
          "Não é possível excluir a conta principal. Esta conta é necessária para o funcionamento do sistema."
        );
      }
    ...
    try {
      ...
      try {
        ...
        const invites = JSON.parse(
          localStorage.getItem("account_invites") || "[]"
        );
        const newInvite = {
          id: `local_${Date.now()}`,
          account_id: accountId,
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="kr">Krone (kr)</SelectItem>
