...
export default function FloatingChat({
  ...
  return (
    <>
      ...
      <div className="fixed top-4 right-4 z-[9999] bg-red-500 text-white p-4 rounded text-lg font-bold border-4 border-yellow-400">
        🔴 CHAT DEBUG: {isOpen ? "ABERTO" : "FECHADO"} 🔴
      </div>
      ...
      {/* Botão adicional no centro da tela para teste */}
      <Button
        onClick={() => {
          console.log("🟡 Botão de teste clicado!");
          setIsOpen(true);
        }}
        className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-16 w-32 bg-blue-500 hover:bg-blue-600 text-white font-bold z-[9999] border-4 border-white"
      >
        TESTE CHAT
      </Button>
